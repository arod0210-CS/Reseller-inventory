document.addEventListener("DOMContentLoaded", function () {
  ...
  function showConfirm(options) {
    refs.confirmMessage.textContent = options.message || "";
    refs.confirmBtn.textContent = options.confirmLabel || t("btnConfirm");
    refs.confirmCancelBtn.textContent = options.cancelLabel || t("btnCancel");
    refs.confirmBtn.className = "btn " + (options.danger ? "btn-danger" : "btn-primary");
    _confirmCallback = options.onConfirm || null;
    refs.confirmBackdrop.classList.add("show");
  }

  function closeConfirm() {
    refs.confirmBackdrop.classList.remove("show");
  ...
  function closeTransaction(force) {
    if (!force && isTransactionDirty()) {
      showConfirm({
        message: t("discardTransaction"),
        confirmLabel: t("btnDiscard"),
        cancelLabel: t("btnCancel"),
        onConfirm: function () { doCloseTransaction(); }
      });
      return;
    }
    doCloseTransaction();
  ...
  function resetDemoData() {
    showConfirm({
      ...
      confirmLabel: t("btnReset"),
      cancelLabel: t("btnCancel"),
      danger: true,
      onConfirm: function () { doResetDemoData(); }
    });
  }

  function doResetDemoData() {
    try {
  ...
  refs.confirmBtn.addEventListener("click", function () {
  ...
  refs.confirmBackdrop.addEventListener("click", function (event) {
  ...
  document.addEventListener("keydown", function (event) {
    ...
    if (refs.confirmBackdrop.classList.contains("show")) {
      closeConfirm();
      return;
    }
    if (refs.labelBackdrop.classList.contains("show")) {
